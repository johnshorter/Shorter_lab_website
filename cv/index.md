...
{% include button.html type="orcid" text="ORCID" link="0000-0003-4732-5526" %}
{% include button.html type="google-scholar" text="Google Scholar" link="cj6-bD4AAAAJ" %}

*Research interests:* statistical and psychiatric genetics; polygenic risk prediction; pharmacogenomics and precision medicine; register- and biobank-based epidemiology using Danish national registries, the Danish Blood Donor Study, and the Copenhagen Hospital Biobank.
...
- Board member, Danish Society for Personalized Medicine (2026–present)
- Panel member, DDSA Young Academy (2024–present)
- Member: Danish Data Science Academy; Nordic and European Societies of Human Genetics (NSHG, ESHG)
- Ad-hoc peer reviewer: PLOS Genetics, PLOS ONE, G3, Molecular Ecology, and others

## Science communication & outreach

- Research on depression genetics and suicide-risk prediction featured in *Aktuel Naturvidenskab* and Danish national media (2025)
- Author, popular-science article *Registerdata og depression i Skandinavien*, *Aktuel Naturvidenskab* (2023)
- Public lecture, Brain Awareness Symposium, NC Museum of Natural Sciences (2015)
